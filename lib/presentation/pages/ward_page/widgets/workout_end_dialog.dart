...
class WorkoutEndDialog extends StatelessWidget {
  const WorkoutEndDialog({super.key});
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    'Данная тренировка будет отправлена пользователю ${wardsBloc.selectedWard?.name ?? ''}',
                    textAlign: TextAlign.center,
                    ...
                    children: [
                      Expanded(
                        child: PrimaryAppButton(
                          onTap: (){
                            context.read<WardsBloc>().add(const WardsEvent.currentWorkoutEnd());
