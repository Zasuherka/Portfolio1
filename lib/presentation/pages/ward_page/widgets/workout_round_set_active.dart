...
class _WorkoutRoundSetActiveState extends State<WorkoutRoundSetActive> {
  ...
  Widget build(BuildContext context) {
    ...
    final ExerciseRoundSet exerciseRoundSet =
        wardsBloc.workout.listExercise[widget.indexExercise] as ExerciseRoundSet;
    physicalActivityList.clear();
    physicalActivityList.addAll(exerciseRoundSet.physicalActivityList);
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
            ...
            children: [
              ...
              Expanded(
                ...
                child: ActiveWorkOutTitle(
                  ...
                  onChanged: (_) {
                    widget.onChanged(
                        titleController.text, setCountController.text, physicalActivityList);
                  },
                ),
              ),
              const SizedBox(
          ...
          physicalActivityList.isNotEmpty && (wardsBloc.state is! Loading)
              ? Table(
                    ...
                    return TableRow(children: [
                      TableCell(
                          ...
                          child: TextFormField(
                            ...
                            maxLength: 15,
                            onTapOutside: (_){
                              wardsBloc.add(WardsEvent.setCurrentRoundSet(
                                list: physicalActivityList,
                                title: titleController.text,
                                setCount: setCountController.text,
                              ));
                            },
