            ...
            child: _focused
                ? Column(
                    ...
                    children: [
                      GestureDetector(
                        onTap: () {
                          context.read<WardsBloc>().add(WardsEvent.addNewExerciseSet(
                                list: widget.training,
                                exerciseCase: ExerciseCase.set,
                              )
                          );
                          _node.unfocus();
                        },
                      ...
                      GestureDetector(
                        onTap: () {
                          context.read<WardsBloc>().add(WardsEvent.addNewExerciseSet(
                            list: widget.training,
                            exerciseCase: ExerciseCase.roundSet,
                          )
                          );
                          _node.unfocus();
                        },
                      ...
                      GestureDetector(
                        onTap: () {
                          context.read<WardsBloc>().add(WardsEvent.addNewExerciseSet(
                            list: widget.training,
                            exerciseCase: ExerciseCase.cardio,
                          ));
                          _node.unfocus();
                        },
                        child: Container(
