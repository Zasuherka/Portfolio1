...
class RemoveCoachDialog extends StatelessWidget {
  const RemoveCoachDialog({super.key});
                    ...
                    children: [
                      Expanded(
                        child: PrimaryAppButton(
                          onTap: (){
                            context.read<CoachBloc>().add(const CoachEvent.removeCoach());
